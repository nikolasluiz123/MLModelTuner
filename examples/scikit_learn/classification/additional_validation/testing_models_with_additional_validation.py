...
from wrappers.scikit_learn import ClassifierAdditionalValidator
...
final_validator = ClassifierAdditionalValidator(estimator=best_estimator, data_x=x, data_y=y)
